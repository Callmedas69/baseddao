    ...
    <div className={clsx("flex flex-col gap-6", hidden && "hidden")}>
      <ExternalLink href="https://bridge.base.org/deposit">
        <div className="flex flex-row gap-2">
          ...
          <span className="font-bold text-[#DEC331] border-white rounded-lg bg-[#182e6f]/90 px-5">
            Bridge to Base
          </span>
        </div>
      </ExternalLink>
      <div className={clsx("flex flex-row flex-wrap gap-4 items-start ")}>
        <div className="shrink flex flex-col gap-1">
          <input
            ...
            className={clsx(
              "bg-primary h-[59px] rounded-[18px] px-6 py-4 focus:border-accent border-2 outline-none text-blue-900",
